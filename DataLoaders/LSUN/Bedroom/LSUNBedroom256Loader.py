...
class DataLoader:
    def __init__(self, batch_size):
        self.dataset_name = 'LSUN Bedroom 256'
        self.batch_size = batch_size
        self.buffer_batch_ratio = 100
        self.iter = 0
        self.image_size = [-1, 256, 256, 3]
        self.dataset_dir = str(Path.home())+'/Datasets/LSUN/Bedroom/LSUNBedroom256/'
        try: self.load_h5()
    ...
    def load_h5(self):
        processed_file_path = self.dataset_dir + 'lsun_bedroom_256.h5'
    ...
    def create_h5(self, chunk_size=20000, test_percentage = 0.2, remove_extracted_files=False):
        ...
        with lmdb.open(source_dir + 'bedroom_val_lmdb/', map_size=1099511627776, max_readers=100, readonly=True).begin(write=False) as txn:
            ...
            for key, val in txn.cursor():
                ...
                validation_images_data[i, ...] = cropped_image
                i += 1
        hf.flush()
        gc.collect(); gc.collect()
