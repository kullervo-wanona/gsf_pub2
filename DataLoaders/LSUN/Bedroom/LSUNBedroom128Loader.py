...
class DataLoader:
    def __init__(self, batch_size):
        self.dataset_name = 'LSUN Bedroom 128'
        self.batch_size = batch_size
        self.buffer_batch_ratio = 200
        self.iter = 0
        self.image_size = [-1, 128, 128, 3]
        self.dataset_dir = str(Path.home())+'/Datasets/LSUN/Bedroom/LSUNBedroom128/'
        try: self.load_h5()
    ...
    def load_h5(self):
        processed_file_path = self.dataset_dir + 'lsun_bedroom_128.h5'
